...
int main(void)
{
  ...
  status = xTaskCreate(led_inbuilt, "LED_on", 200, NULL, 2, &task1_handle);
  status = xTaskCreate(led_2, "LED", 200, NULL, 2, &task2_handle);
  //status = xTaskCreate(led_2, "LED_off", 200, NULL, 2, &task2_handle);
